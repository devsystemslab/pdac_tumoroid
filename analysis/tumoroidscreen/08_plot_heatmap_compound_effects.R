...
dir_tables <- 'analysis/tumoroidscreen/tables/'
# read data
...
ggsave(plot=p[[4]],'analysis/tumoroidscreen/plots/heatmap_expr.pdf')
...
# save plot
ggsave('analysis/tumoroidscreen/plots/interaction_heatmap_merged.pdf', plot = p_heatmap_org_features[[4]],
       dpi = 112, unit = 'mm', width = 400.05, height = 215.22)

ggsave('analysis/tumoroidscreen/plots/expr_heatmap_merged.pdf', plot = p_heatmap_target_expr[[4]],
       dpi = 112, unit = 'mm', width = 400.05, height = 215.22)
