...
ggsave('data/pilotscreen/plots/organoid_embeddings_umaps_only.pdf', plot = p_umaps,
       dpi = 112, unit = 'mm', width = 400.05, height = 215.22)
ggsave('data/pilotscreen/plots/organoid_embeddings_umaps_only.png', plot = p_umaps,
       dpi = 112, unit = 'mm', width = 400.05, height = 215.22)
...
ggsave('data/pilotscreen/plots/organoid_embeddings_cluster_composition.pdf',
       plot = p7,
...
ggsave('data/pilotscreen/plots/organoid_embeddings.pdf', plot = p,
       dpi = 112, unit = 'mm', width = 400.05, height = 215.22)
...
ggsave('data/pilotscreen/plots/correlation_graph_features.png', plot = p,
...
# save with ggsave
ggsave('data/pilotscreen/plots/correlation_heatmap_features.png', plot = plot[[4]],
       dpi = 112, unit = 'mm', width = 400.05, height = 400.05)
...
ggsave('data/pilotscreen/plots/z_prime.pdf', plot = p_z_prime,
       dpi = 112, unit = 'mm', width = 400.05, height = 215.22)
...
ggsave('data/pilotscreen/plots/interaction_heatmap_merged.pdf', plot = p_heatmap_merged[[4]],
       dpi = 112, unit = 'mm', width = 400.05, height = 215.22)
