...
file_cycle_01_pp = (
    f"{dir_adata}/mdata_cycle-01_inhibitors_noplatecondition_postprocessing.h5mu"
)
file_cycle_03_pp = (
    f"{dir_adata}/mdata_cycle-03_inhibitors_noplatecondition_postprocessing.h5mu"
)
...
# organoid embeddings
file_org_cycle_01 = (
    f"{dir_adata}/mdata_org_default_cycle-01_inhibitors_noplatecondition.h5mu"
)
file_org_cycle_03 = (
    f"{dir_adata}/mdata_org_default_cycle-03_inhibitors_noplatecondition.h5mu"
)
...
# write mdatas
mdata_org_cycle_01.write_h5mu(
    f"{dir_adata}/mdata_org_chull_cycle-01_inhibitors_noplatecondition.h5mu"
)
mdata_org_cycle_03.write_h5mu(
    f"{dir_adata}/mdata_org_chull_cycle-03_inhibitors_noplatecondition.h5mu"
)
