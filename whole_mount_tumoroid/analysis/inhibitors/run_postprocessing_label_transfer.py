...
import muon as mu
from whole_mount_tumoroid.analysis.utils import run_umap_gpu, merge_org_embeddings, run_chulls_connected_components, add_chull_stats_to_mdata_org
from whole_mount_tumoroid.phenocoder.plot import plot_clustermap, plot_organoid

# set paths
dir_adata = '/pstore/data/ihb-tumoroidscreen/data/processed/inhibitors/anndata'
#file_registered = f'{dir_adata}/mdata_registered.h5mu'
file_cycle_01 = f'{dir_adata}/mdata_cycle-01_inhibitors_noplatecondition.h5mu'
file_cycle_03 = f'{dir_adata}/mdata_cycle-03_inhibitors_noplatecondition.h5mu'
...
file_cycle_01_pp = f'{dir_adata}/mdata_cycle-01_inhibitors_noplatecondition_postprocessing.h5mu'
file_cycle_03_pp = f'{dir_adata}/mdata_cycle-03_inhibitors_noplatecondition_postprocessing.h5mu'
...
# organoid embeddings
file_org_cycle_01 = f'{dir_adata}/mdata_org_default_cycle-01_inhibitors_noplatecondition.h5mu'
file_org_cycle_03 = f'{dir_adata}/mdata_org_default_cycle-03_inhibitors_noplatecondition.h5mu'
...
# write mdatas
mdata_org_cycle_01.write_h5mu(f'{dir_adata}/mdata_org_chull_cycle-01_inhibitors_noplatecondition.h5mu')
mdata_org_cycle_03.write_h5mu(f'{dir_adata}/mdata_org_chull_cycle-03_inhibitors_noplatecondition.h5mu')
...
# write mdata
file_combined = f'{dir_adata}/mdata_org_combined_inhibitors_noplatecondition.h5mu'
