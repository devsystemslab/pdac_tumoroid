...
from whole_mount_tumoroid.phenocoder.plot import RGBRotate
from whole_mount_tumoroid.phenocoder.utils import get_metadata
...
if __name__ == "__main__":
    ...
    df_stains = pd.read_csv(
        "whole_mount_tumoroid/metafiles/timecourse_stainings_metadata.csv"
    )
    df_plate_layout = pd.read_csv(
        "whole_mount_tumoroid/metafiles/timecourse_layout.csv"
    )
